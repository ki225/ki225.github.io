...
import { loadAllPosts, getAllCategories, getAllTags, filterPostsByCategory, searchPosts, formatDate, type BlogPost } from '../utils/blogParser'
...
function BlogList() {
  ...
  const categoryImages: { [key: string]: string } = {
    ...
    'Development': 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800',
      ...
      <main className="blog-main">
        <div className="blog-header">
          <div>
            ...
            <p className="blog-description">
              Tech notes on cloud, networking, AI, and development. Learning, breaking, fixing, and sharing.
            </p>
          </div>
        ...
        <section className="articles-section">
          <div className="section-header">
            <h2>Articles <span className="article-count">{displayedPosts.length}</span></h2>
          ...
          <div className="articles-grid">
            {displayedPosts.map((post) => (
              <Link key={post.id} to={`/blog/${post.slug}`} className="article-card">
                <div className="article-image">
                  <img 
                    src={post.thumbnail || categoryImages[post.category] || 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800'} 
                    alt={post.title} 
                  />
          ...
          {displayedPosts.length === 0 && (
            <div className="no-results">
              ...
              {(searchParams.get('search') || searchParams.get('tag') || searchParams.get('category')) && (
                <button 
